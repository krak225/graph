	...
	<div class="row">
		<div class="col-md-12">
			<ul class="nav nav-tabs">
				...
				<li id="ong-sinistre">Statistiques journalières</li>
			</ul>
			<div class="tab-content">
				<div id="home" class="tab-pane fade in active">
					<div class="row" >
						<div class="col-md-12 panel hide"  style="height:550px " id="stats_journalieres_suivi_recettes_assites">
						
						</div>
					</div>
					
					<div class="row" style="border-top:2px solid red;padding:10px;margin:10px;">
						<div class="col-md-12 panel hide"  style="height:550px " id="stats_journalieres_suivi_recettes_assites_cumulatives">
...
function createChart() {
    ...
    Highcharts.stockChart('stats_journalieres_suivi_recettes_assites', {
		title: {
...
function createChartCumul() {
    ...
    // Create the chart
	Highcharts.stockChart('stats_journalieres_suivi_recettes_assites_cumulatives', {
...
function createChartJournalieres(data) {
	...
	Highcharts.chart('stats_journalieres', {
                title: {
...
let date_debut = '';
Highcharts.getJSON(
    'http://127.0.0.1/digigraph/public/stats_journalieres_data?d='+date_debut,
